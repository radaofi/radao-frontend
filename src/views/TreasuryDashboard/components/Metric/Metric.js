...
export const OHMPrice = () => {
  ...
  return (
    <Metric className="price">
      <Metric.Title>RA Price</Metric.Title>
...
export const BackingPerOHM = () => {
  ...
  return (
    <Metric className="bpo">
      <Metric.Title>Backing per RA</Metric.Title>
...
export const CurrentIndex = () => {
  ...
  return (
    <Metric className="index">
      <Metric.Title>
        Current Index
        <InfoTooltip message="The current index tracks the amount of sRA accumulated since the beginning of staking. Basically, how much sOHM one would have if they staked and held a single OHM from day 1." />
      </Metric.Title>
      <Metric.Value>{currentIndex && trim(currentIndex, 2) + " sRA"}</Metric.Value>
    </Metric>
  );
};
  ...
  return (
    <Metric className="wsoprice">
      <Metric.Title>
        ...
        <InfoTooltip
          message={
            "wsRA = sRA * index\n\nThe price of wsRA is equal to the price of RA multiplied by the current index"
          }
        />
      </Metric.Title>
