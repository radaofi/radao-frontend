...
import MonumentExtended from "../assets/fonts/MonumentExtended-Regular.otf";
import MonumentExtendedBold from "../assets/fonts/MonumentExtended-Ultrabold.otf";

const monumentExtended = {
  ...
  src: `
		...
		url(${MonumentExtended})
	`,
};
const monumentExtendedBold = {
  fontFamily: "Monument Extended",
  fontStyle: "normal",
  fontDisplay: "swap",
  fontWeight: 600,
...
const fonts = [
  ...
  // square, squareLight, squareMedium, squareBold, squareItalic
];
