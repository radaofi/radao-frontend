...
import { ra_busd } from "./AllBonds";
import { JsonRpcSigner, StaticJsonRpcProvider } from "@ethersproject/providers";
import { IBaseAsyncThunk } from "src/slices/interfaces";
import { PairContract, RedeemHelper } from "../typechain";

export async function getMarketPrice({ networkID, provider }: IBaseAsyncThunk) {
  const ra_busd_address = ra_busd.getAddressForReserve(networkID);
  const pairContract = new ethers.Contract(ra_busd_address, PairContractABI, provider) as PairContract;
 ...
 */
export async function getTokenPrice(tokenId = "radao") {
  let resp;
  try {
